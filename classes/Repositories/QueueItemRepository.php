...
use OnlinePayments\Core\Infrastructure\ORM\Interfaces\QueueItemRepository as CoreQueueItemRepository;
    ...
    protected function getQueuedItems(int $priority, array $runningQueueNames, int $limit): array
    {
        ...
        try {
            ...
            $query = 'SELECT queueTable.id,queueTable.data'
                ...
                . ' INNER JOIN ' . bqSQL(_DB_PREFIX_ . $this->getDbName()) . ' AS queueTable'
