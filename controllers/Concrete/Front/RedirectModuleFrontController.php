...
class RedirectModuleFrontController extends \ModuleFrontController
{
     ...
     * @throws \Exception
     */
    public function displayAjaxRedirectExternalOld()
    {
        ...
        try {
            ...
            $this->logger->error($e->getMessage(),
                ['hostedCheckout' => json_decode(json_encode($hostedCheckout), true)]);
            \Tools::redirect($this->context->link->getPageLink(
                'order',
                null,
                null,
     ...
     * @throws \PrestaShopException
     */
    public function displayAjaxRedirectReturnHostedOld()
    {
        /** @var \WorldlineOP\PrestaShop\Logger\LoggerFactory $loggerFactory */
        $loggerFactory = $this->module->getService('worldlineop.logger.factory');
     ...
     * @throws \PrestaShopException
     */
    public function displayAjaxRedirectReturnIframeOld()
    {
        /** @var \WorldlineOP\PrestaShop\Logger\LoggerFactory $loggerFactory */
        $loggerFactory = $this->module->getService('worldlineop.logger.factory');
     ...
     * @throws \PrestaShopException
     */
    public function displayAjaxRedirectReturnInternalIframeOld()
    {
        /** @var \WorldlineOP\PrestaShop\Logger\LoggerFactory $loggerFactory */
        $loggerFactory = $this->module->getService('worldlineop.logger.factory');
