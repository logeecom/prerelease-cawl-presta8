...
use OnlinePayments\Core\Tests\Infrastructure\Common\TestComponents\TaskExecution\AbortTask;
use OnlinePayments\Core\Tests\Infrastructure\Common\TestComponents\TaskExecution\BarTask;
...
class QueueTest extends TestCase
{
     ...
     * @throws QueueStorageUnavailableException
     * @throws \OnlinePayments\Core\Infrastructure\TaskExecution\Exceptions\AbortTaskExecutionException
     */
    ...
    /**
     * @param \OnlinePayments\Core\Infrastructure\TaskExecution\QueueItem $queueItem
     *
     * @throws EntityClassException
     * @throws QueryFilterInvalidParamException
     * @throws QueueItemDeserializationException
     ...
     * @param \OnlinePayments\Core\Infrastructure\TaskExecution\Task $task
     *
     * @return \OnlinePayments\Core\Infrastructure\TaskExecution\QueueItem
     *
     * @throws QueueItemDeserializationException
     * @throws QueueStorageUnavailableException
     * @throws \OnlinePayments\Core\Infrastructure\TaskExecution\Exceptions\AbortTaskExecutionException
     ...
     *
     * @param \OnlinePayments\Core\Infrastructure\TaskExecution\QueueItem $needle
