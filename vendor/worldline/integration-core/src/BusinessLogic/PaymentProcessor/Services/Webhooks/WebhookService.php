...
namespace CAWL\OnlinePayments\Core\BusinessLogic\PaymentProcessor\Services\Webhooks;
...
class WebhookService
{
     ...
     */
    public function __construct(StatusUpdateService $statusUpdateService, PaymentTransactionRepositoryInterface $paymentTransactionRepository)
    {
