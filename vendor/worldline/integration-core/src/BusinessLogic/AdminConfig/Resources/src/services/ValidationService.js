...
(function () {
    ...
    const { templateService, utilities, translationService } = OnlinePaymentsFE;
    ...
    const setError = (element, message) => {
        ...
        if (message) {
            ...
            if (!errorField) {
                errorField = OnlinePaymentsFE.elementGenerator.createElement('span', 'opp-input-error', message);
                parent.append(errorField);
            }

            errorField.innerHTML = OnlinePaymentsFE.sanitize(translationService.translate(message));
        }
    };
    ...
    OnlinePaymentsFE.validationService = {
        setError,
        removeError,
        validateEmail,
        validateNumber,
