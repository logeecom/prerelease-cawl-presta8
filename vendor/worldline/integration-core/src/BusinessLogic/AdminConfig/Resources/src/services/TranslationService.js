...
(function () {
     ...
     * The translations are used from the global OnlinePaymentsFE.translations object. It expects two keys in this object:
    ...
    function TranslationService() {
        ...
        const getTranslation = (type, group, key) => {
            if (OnlinePaymentsFE.translations[type][group] && OnlinePaymentsFE.translations[type][group]) {
                let value = OnlinePaymentsFE.translations[type][group];
    ...
    OnlinePaymentsFE.translationService = new TranslationService();
})();
