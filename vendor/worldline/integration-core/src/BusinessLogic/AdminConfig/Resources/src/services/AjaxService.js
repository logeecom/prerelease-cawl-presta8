...
(function () {
    ...
    const AjaxService = () => {
        ...
        const handleResponse = (response, errorCallback) => {
            if (!errorCallback) {
                errorCallback = OnlinePaymentsFE.responseService.errorHandler;
            }
            ...
            try {
                ...
                if (response.status === 401) {
                    ...
                    return response.json().then(OnlinePaymentsFE.responseService.unauthorizedHandler).catch(errorCallback);
                }
    ...
    OnlinePaymentsFE.ajaxService = AjaxService();
})();
