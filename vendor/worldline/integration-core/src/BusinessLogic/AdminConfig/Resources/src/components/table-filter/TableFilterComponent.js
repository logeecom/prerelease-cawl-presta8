...
(function () {
     ...
     */
    const { elementGenerator: generator, components } = OnlinePaymentsFE;
    ...
    const create = ({
        ...
        const fireOnChange = (values) => {
            ...
            button.firstElementChild.innerHTML = OnlinePaymentsFE.sanitize(getButtonLabel(label, labelPlural, options, selectedValues));
            button.lastElementChild.innerHTML = OnlinePaymentsFE.sanitize(getButtonTooltip(label, options, selectedValues));
    ...
    OnlinePaymentsFE.components.TableFilter = {
        create
    };
})();
