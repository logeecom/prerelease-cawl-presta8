...
(function () {
    function UtilityService() {
        ...
        this.createFlashMessage = (message, status, clearAfter) => {
            return OnlinePaymentsFE.elementGenerator.createFlashMessage(message, status, clearAfter);
        };
        ...
        this.create401FlashMessage = (message) => {
            ...
            const messageElement = OnlinePaymentsFE.elementGenerator.createFlashMessage(message, 'error');
            messageElement.classList.add('opv--401-error');
            OnlinePaymentsFE.templateService.getHeaderSection().append(messageElement);
        };
         ...
         */
        this.remove401Message = () => {
            OnlinePaymentsFE.templateService
                .getHeaderSection()
        ...
        this.createToasterMessage = (message, type = 'success') => {
            document.getElementById('op-page').append(OnlinePaymentsFE.elementGenerator.createToaster(message, type));
        };
    ...
    OnlinePaymentsFE.utilities = new UtilityService();
})();
