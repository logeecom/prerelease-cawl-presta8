...
(function () {
    ...
    const Header = ({
        ...
        if (window.innerWidth <= 1280) {
            logoWrapper.appendChild(generator.createElement('img', '', '', {'alt': 'logo', 'src': './assets/images/' + brand + '-small.svg'}));
        } else {
            logoWrapper.appendChild(generator.createElement('img', '', '', {'alt': 'logo', 'src': './assets/images/' + brand + '.svg'}));
        }
