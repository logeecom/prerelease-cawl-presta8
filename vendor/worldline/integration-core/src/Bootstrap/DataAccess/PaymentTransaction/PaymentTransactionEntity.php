...
class PaymentTransactionEntity extends Entity
{
    ...
    public function inflate(array $data): void
    {
        ...
        $this->paymentTransaction = new PaymentTransaction(
            ...
            $paymentTransaction['paymentId'] ? PaymentId::parse($paymentTransaction['paymentId']) : null,
            $paymentTransaction['returnHmac'],
            StatusCode::parse((int)$paymentTransaction['statusCode']),
            $paymentTransaction['customerId'],
            $paymentTransaction['cratedAt'] ? $timeProvider->getDateTime($paymentTransaction['cratedAt']) : null,
            $paymentTransaction['updatedAt'] ?  $timeProvider->getDateTime($paymentTransaction['updatedAt']) : null,
            $paymentTransaction['returnedAt'] ? $timeProvider->getDateTime($paymentTransaction['returnedAt']) : null,
            $paymentTransaction['paymentMethod'] ?: null,
            $paymentTransaction['captureAt'] ? $timeProvider->getDateTime($paymentTransaction['captureAt']) : null,
            $paymentTransaction['paymentLinkId']
        );
    }
    ...
    public function toArray(): array
    {
        ...
        $data['paymentTransaction'] = [
            ...
            'cratedAt' => $createdAt ? $createdAt->getTimestamp() : null,
            'updatedAt' => $updatedAt ? $updatedAt->getTimestamp() : null,
            'returnedAt' => $returnedAt ? $returnedAt->getTimestamp() : null,
            'paymentMethod' => $this->paymentTransaction->getPaymentMethod(),
            'captureAt' => $captureAt ? $captureAt->getTimestamp() : null,
            'paymentLinkId' => $this->paymentTransaction->getPaymentLinkId(),
        ];
