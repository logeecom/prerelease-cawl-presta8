...
use OnlinePayments\Core\BusinessLogic\Domain\Monitoring\WebhookLog as DomainWebhookLog;
...
class WebhookLog extends Entity
{
    ...
    public function inflate(array $data): void
    {
        ...
        $this->webhookLog = new DomainWebhookLog(
            $logData['orderId'] ?? '',
    ...
    public function toArray(): array
    {
        ...
        $data['webhookLog'] = [
            ...
            'paymentMethod' => $this->webhookLog->getPaymentMethod(),
            'status' => $this->webhookLog->getStatus(),
            'type' => $this->webhookLog->getType(),
            'createdAt' => $this->webhookLog->getCreatedAt() ? $this->webhookLog->getCreatedAt()->getTimestamp() : '',
            'statusCode' => $this->webhookLog->getStatusCode(),
            'webhookBody' => $this->webhookLog->getWebhookBody(),
            'transactionLink' => $this->webhookLog->getTransactionLink(),
            'orderLink' => $this->webhookLog->getOrderLink()
        ];
