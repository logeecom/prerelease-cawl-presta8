...
class PaymentLinkEntity extends Entity
{
    ...
    public function inflate(array $data): void
    {
        ...
        $this->paymentLink = new PaymentLink(
            ...
            $data['paymentLink']['merchantReference'],
            $data['paymentLink']['paymentId'],
            $data['paymentLink']['expiresAt'] ? $timeProvider->getDateTime($data['paymentLink']['expiresAt']) : null,
            $data['paymentLink']['redirectionUrl'],
    ...
    public function toArray(): array
    {
        ...
        $data['paymentLink'] = [
            'paymentLinkId' => $this->paymentLink->getPaymentLinkId(),
            'merchantReference' => $this->paymentLink->getMerchantReference(),
            'paymentId' => $this->paymentLink->getPaymentId(),
            'expiresAt' => $expiresAt ? $expiresAt->getTimestamp() : null,
            'redirectionUrl' => $this->paymentLink->getRedirectionUrl(),
            'status' => $this->paymentLink->getStatus(),
        ];
