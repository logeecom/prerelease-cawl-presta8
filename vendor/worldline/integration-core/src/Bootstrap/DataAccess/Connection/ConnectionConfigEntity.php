...
class ConnectionConfigEntity extends Entity
{
    ...
    public function inflate(array $data): void
    {
        ...
        if (!empty($connectionDetails['liveCredentials'])) {
            $liveCredentials = new Credentials(
                $connectionDetails['liveCredentials']['pspId'],
                $connectionDetails['liveCredentials']['apiKey'],
                $connectionDetails['liveCredentials']['apiSecret'],
                $connectionDetails['liveCredentials']['webhookKey'],
                $connectionDetails['liveCredentials']['webhookSecret']
            );
        }

        if (!empty($connectionDetails['testCredentials'])) {
            $testCredentials = new Credentials(
                $connectionDetails['testCredentials']['pspId'],
                $connectionDetails['testCredentials']['apiKey'],
                $connectionDetails['testCredentials']['apiSecret'],
                $connectionDetails['testCredentials']['webhookKey'],
                $connectionDetails['testCredentials']['webhookSecret']
            );
        }

        $this->connectionDetails = new ConnectionDetails(
            ConnectionMode::parse($connectionDetails['mode']),
            $liveCredentials,
            $testCredentials
        );
    }
    ...
    public function toArray(): array
    {
        ...
        $data['connectionDetails'] = [
            'mode' => (string)$this->connectionDetails->getMode(),
        ];
        if ($this->connectionDetails->getLiveCredentials()) {
            $data['connectionDetails']['liveCredentials'] = [
                'pspId' => $this->connectionDetails->getLiveCredentials()->getPspId(),
                'apiKey' => $this->connectionDetails->getLiveCredentials()->getApiKey(),
                'apiSecret' => $this->connectionDetails->getLiveCredentials()->getApiSecret(),
                'webhookKey' => $this->connectionDetails->getLiveCredentials()->getWebhookKey(),
                'webhookSecret' => $this->connectionDetails->getLiveCredentials()->getWebhookSecret(),
            ];
        }
        if ($this->connectionDetails->getTestCredentials()) {
            $data['connectionDetails']['testCredentials'] = [
                'pspId' => $this->connectionDetails->getTestCredentials()->getPspId(),
                'apiKey' => $this->connectionDetails->getTestCredentials()->getApiKey(),
                'apiSecret' => $this->connectionDetails->getTestCredentials()->getApiSecret(),
                'webhookKey' => $this->connectionDetails->getTestCredentials()->getWebhookKey(),
                'webhookSecret' => $this->connectionDetails->getTestCredentials()->getWebhookSecret(),
            ];
        }
